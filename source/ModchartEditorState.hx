...
class ModchartEditorState extends MusicBeatState {
	...
	override function create() {
		...
		DiscordClient.changePresence("In the Modchart Editor Menu", null);
		#end
		
		FlxG.sound.playMusic(Paths.music('modchartMenu/title'), 0);
		...
		informationMenu = new FlxText(5, FlxG.height - 44, 0, "In the Modchart Editor Menu - NEW!", 12);
